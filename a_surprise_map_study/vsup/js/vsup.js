(function (t, e) {
  ...
  function C(t, e, n) {
    (t = +t),
      (e = +e),
      (n = (a = arguments.length) < 2 ? ((e = t), (t = 0), 1) : a < 3 ? 1 : +n);
    for (
      ...
      (u = u.merge(
        ...
        (b = b.merge(
          l
            ...
            .attr("fill", "#000")
            .attr(A, M * r)
            .attr("dy", p === k ? "0em" : p === D ? "0.71em" : "0.32em")
        )),
        t !== o &&
          ((u = u.transition(t)),
          (s = s.transition(t)),
        ...
        u.attr(
          "d",
          p === U || p == P
            ? "M" + M * w + "," + f + "H0.5V" + i + "H" + M * w
            : "M" + f + "," + M * w + "V0.5H" + i + "V" + M * w
        ),
        ...
        o
          ...
          .attr("text-anchor", p === P ? "start" : p === U ? "end" : "middle"),
        o.each(function () {
          this.__axis = c;
        });
    }
    ...
    return function () {
      ...
      if (t) {
        for (var e, n = 0, r = -1, a = t.length; n < a; ++n)
          (e = t[n]),
            (f.type && e.type !== f.type) || e.name !== f.name
              ? (t[++r] = e)
        ...
        for (var i = 0, c = a.length; i < c; ++i)
          if ((r = a[i]).type === o.type && r.name === o.name)
            return (
              ...
              this.addEventListener(r.type, (r.listener = f), (r.capture = s)),
              void (r.value = u)
            );
      this.addEventListener(o.type, f, s),
        (r = { type: o.type, name: o.name, value: u, listener: f, capture: s }),
  ...
  function Ut(t) {
    ...
    return (
      ...
      (e = xt.exec(t))
        ...
        ? zt(e[1], e[2], e[3], e[4])
        : (e = kt.exec(t))
        ? zt((255 * e[1]) / 100, (255 * e[2]) / 100, (255 * e[3]) / 100, e[4])
        : (e = Ct.exec(t))
        ? Yt(e[1], e[2] / 100, e[3] / 100, 1)
        : (e = Pt.exec(t))
        ? Yt(e[1], e[2] / 100, e[3] / 100, e[4])
        : Dt.hasOwnProperty(t)
        ? St(Dt[t])
        : "transparent" === t
  ...
  var ye = (function t(e) {
    ...
    function n(e, t) {
      ...
      return function (t) {
        return (
          (e.r = n(t)), (e.g = r(t)), (e.b = a(t)), (e.opacity = f(t)), e + ""
        );
      };
    }
    return (n.gamma = t), n;
  ...
  function Me(t, r) {
    ...
    for (t += "", r += ""; (e = we.exec(t)) && (n = xe.exec(r)); )
      (a = n.index) > c &&
        ((a = r.slice(c, a)), u[o] ? (u[o] += a) : (u[++o] = a)),
        (e = e[0]) === (n = n[0])
          ? u[o]
            ? (u[o] += n)
            : (u[++o] = n)
          : ((u[++o] = null), s.push({ i: o, x: _e(e, n) })),
        (c = xe.lastIndex);
    return (
      c < r.length && ((a = r.slice(c)), u[o] ? (u[o] += a) : (u[++o] = a)),
      u.length < 2
        ? s[0]
          ? ((i = s[0].x),
            function (t) {
  ...
  function Se(t, e, n, r, a, f) {
    var i, c, o;
    return (
      (i = Math.sqrt(t * t + e * e)) && ((t /= i), (e /= i)),
      (o = t * n + e * r) && ((n -= t * o), (r -= e * o)),
      (c = Math.sqrt(n * n + r * r)) && ((n /= c), (r /= c), (o /= c)),
      t * r < e * n && ((t = -t), (e = -e), (o = -o), (i = -i)),
      {
        translateX: a,
        translateY: f,
        rotate: Math.atan2(e, t) * De,
        skewX: Math.atan(o) * De,
        scaleX: i,
        scaleY: c,
      }
    );
  ...
  function ze(l, h, b, p) {
    ...
    return function (t, e) {
      ...
      return (
        (t = l(t)),
        (e = l(e)),
        (function (t, e, n, r, a, f) {
          if (t !== n || e !== r) {
            var i = a.push("translate(", null, h, null, b);
            f.push({ i: i - 4, x: _e(t, n) }, { i: i - 2, x: _e(e, r) });
          } else (n || r) && a.push("translate(" + n + h + r + b);
        })(t.translateX, t.translateY, e.translateX, e.translateY, s, d),
        (n = t.rotate),
        (r = e.rotate),
        (a = s),
        (f = d),
        n !== r
          ? (180 < n - r ? (r += 360) : 180 < r - n && (n += 360),
            f.push({ i: a.push(g(a) + "rotate(", null, p) - 2, x: _e(n, r) }))
          : r && a.push(g(a) + "rotate(" + r + p),
        (i = t.skewX),
        (c = e.skewX),
        (o = s),
        (u = d),
        i !== c
          ? u.push({ i: o.push(g(o) + "skewX(", null, p) - 2, x: _e(i, c) })
          : c && o.push(g(o) + "skewX(" + c + p),
        (function (t, e, n, r, a, f) {
          if (t !== n || e !== r) {
            var i = a.push(g(a) + "scale(", null, ",", null, ")");
            f.push({ i: i - 4, x: _e(t, n) }, { i: i - 2, x: _e(e, r) });
          } else
            (1 === n && 1 === r) || a.push(g(a) + "scale(" + n + "," + r + ")");
        })(t.scaleX, t.scaleY, e.scaleX, e.scaleY, s, d),
        (t = e = null),
        function (t) {
      ...
      function (t) {
        return "none" === t
          ...
          : (Ne ||
            ...
            (t = Ce.getComputedStyle(ke.appendChild(Ne), null).getPropertyValue(
              "transform"
            )),
            ke.removeChild(Ne),
            Se(
  ...
  function qe(e, t) {
    ...
    return function (t) {
      return (
        (e.l = n(t)), (e.a = r(t)), (e.b = a(t)), (e.opacity = f(t)), e + ""
      );
    };
  }
  function Ye(c) {
  ...
  Je.prototype = Ke.prototype = {
    ...
    restart: function (t, e, n) {
      ...
      (n = (null == n ? Qe() : +n) + (null == e ? 0 : +e)),
        this._next ||
          He === this ||
          (He ? (He._next = this) : (Le = this), (He = this)),
        (this._call = t),
        (this._time = n),
        nn();
    },
  ...
  function bn(t, e, n, r, a, f) {
    ...
    (function (f, i, c) {
      ...
      (u[i] = c).timer = Ke(
        function (t) {
          (c.state = on),
            c.timer.restart(s, c.delay, c.time),
            c.delay <= t && s(t - c.delay);
        },
        0,
        c.time
      );
            ...
            "function" == typeof e
              ? ((u = _),
                ...
                function () {
                  ...
                  return (
                    null == e &&
                      (this.style.removeProperty(o), (e = $(this, o))),
                    t === e
                      ? null
                      : t === d && e === l
                      ? h
        ...
        if (r.charCodeAt(n) === Hn) {
          ...
          return (
            (t = f) >= a
              ...
              : (e = r.charCodeAt(f++)) === On
              ? (o = !0)
              : e === jn && ((o = !0), r.charCodeAt(f) === On && ++f),
            r.slice(n + 1, t - 1).replace(/""/g, '"')
          );
        }
        for (; f < a; ) {
  ...
  function Xn(t, e, n, r) {
    ...
    for (
      ;
      (a = a ? (a[d] = new Array(4)) : (t._root = new Array(4))),
        (u = e >= (f = (p + y) / 2)) ? (p = f) : (y = f),
        (s = n >= (i = (g + v) / 2)) ? (g = i) : (v = i),
        (d = (s << 1) | u) == (l = ((i <= o) << 1) | (f <= c));
  ...
  (Wn.copy = function () {
    ...
    (Wn.addAll = function (t) {
      ...
      for (n = 0; n < f; ++n)
        isNaN((r = +this._x.call(null, (e = t[n])))) ||
          ...
          d < a && (d = a));
      for (
        s < o && ((o = this._x0), (s = this._x1)),
          d < u && ((u = this._y0), (d = this._y1)),
          this.cover(o, u).cover(s, d),
          n = 0;
        n < f;
        ++n
      )
    ...
    (Wn.cover = function (t, e) {
      ...
      var n = this._x0,
        ...
        f = this._y1;
      if (isNaN(n))
        (a = (n = Math.floor(t)) + 1), (f = (r = Math.floor(e)) + 1);
      else {
      ...
      return (
        (this._x0 = n), (this._y0 = r), (this._x1 = a), (this._y1 = f), this
      );
    }),
    (Wn.data = function () {
      var e = [];
    ...
    (Wn.visit = function (t) {
      ...
      for (
        ...
        if (
          ...
          var u = (r + f) / 2,
            s = (a + i) / 2;
          (n = o[3]) && c.push(new $n(n, u, s, f, i)),
            (n = o[2]) && c.push(new $n(n, r, s, u, i)),
            (n = o[1]) && c.push(new $n(n, u, a, f, s)),
            (n = o[0]) && c.push(new $n(n, r, a, u, s));
        }
      return this;
    }),
      ...
      for (
        ...
        if (a.length) {
          var f,
            ...
            s = (i + o) / 2,
            d = (c + u) / 2;
          (f = a[0]) && n.push(new $n(f, i, c, s, d)),
            (f = a[1]) && n.push(new $n(f, s, c, o, d)),
            (f = a[2]) && n.push(new $n(f, i, d, s, u)),
            (f = a[3]) && n.push(new $n(f, s, d, o, u));
        }
        r.push(e);
      }
    ...
    function i(t) {
      ...
      function n(t) {
          ...
          if (
            ...
            for (e = -1, n = t.length; ++e < n; )
              if ((r = t.charCodeAt(e)) < 48 || 57 < r) {
                (f = (46 === r ? x + t.slice(e + 1) : t.slice(e)) + f),
                  (t = t.slice(0, e));
                break;
              }
        }
        ...
        switch (
          (b &&
            l &&
            ((t = w(o + t, o.length ? h - f.length : 1 / 0)), (o = "")),
          s)
        ) {
          case "<":
            t = a + t + f + o;
  ...
  function _r() {
    ...
    function e() {
      var t = c().length,
        ...
        n = u[e - 0],
        r = u[1 - e];
      (f = (r - n) / Math.max(1, t - d + 2 * l)),
        s && (f = Math.floor(f)),
        (n += (r - n - f * (t - d)) * h),
        (i = f * (1 - d)),
        s && ((n = Math.round(n)), (i = Math.round(i)));
  ...
  function Tr(t, e, n, r) {
    var a = t[0],
      ...
      c = e[1];
    return (
      f < a ? ((a = n(f, a)), (i = r(c, i))) : ((a = n(a, f)), (i = r(i, c))),
      function (t) {
        return i(a(t));
      }
    );
  ...
  function Pr() {
    var e = (function (e, n) {
      ...
      function a() {
        return (
          (r = 2 < Math.min(c.length, o.length) ? Nr : Tr), (f = i = null), t
        );
      }
      function t(t) {
        return (
    ...
    return (
      ...
      n &&
        ((c.count = function (t, e) {
          return (
            Dr.setTime(+t), Ur.setTime(+e), f(Dr), f(Ur), Math.floor(n(Dr, Ur))
          );
        }),
        (c.every = function (e) {
          return (
  ...
  function La(t, e) {
    var n = t.getDay();
    return (
      (t = 4 <= n || 0 === n ? Or(t) : Or.ceil(t)),
      fa(Or.count(jr(t), t) + (4 === jr(t).getDay()), e, 2)
    );
  }
  function Ha(t) {
    return t.getDay();
  ...
  function nf(t, e) {
    var n = t.getUTCDay();
    return (
      (t = 4 <= n || 0 === n ? Zr(t) : Zr.ceil(t)),
      fa(Zr.count(Gr(t), t) + (4 === Gr(t).getUTCDay()), e, 2)
    );
  }
  function rf(t) {
    return t.getUTCDay();
  ...
  hf("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
    hf("7fc97fbeaed4fdc086ffff99386cb0f0027fbf5b17666666"),
    hf("1b9e77d95f027570b3e7298a66a61ee6ab02a6761d666666"),
    hf(
      "a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928"
    ),
    hf("fbb4aeb3cde3ccebc5decbe4fed9a6ffffcce5d8bdfddaecf2f2f2"),
    hf("b3e2cdfdcdaccbd5e8f4cae4e6f5c9fff2aef1e2cccccccc"),
    hf("e41a1c377eb84daf4a984ea3ff7f00ffff33a65628f781bf999999"),
    hf("66c2a5fc8d628da0cbe78ac3a6d854ffd92fe5c494b3b3b3"),
    hf(
    ...
    Ie(de(300, 0.5, 0), de(-240, 0.5, 1));
  Ie(de(-100, 0.75, 0.35), de(80, 1.5, 0.8)),
    Ie(de(260, 0.75, 0.35), de(80, 1.5, 0.8)),
    de();
  function pf(e) {
    var n = e.length;
    return function (t) {
    ...
    return (
      (e.centroid = function () {
        var t = (+G.apply(this, arguments) + +B.apply(this, arguments)) / 2,
          e =
            (+J.apply(this, arguments) + +K.apply(this, arguments)) / 2 -
            Nf / 2;
          ...
          i.svgGroup
            ...
            .on("mouseout", function (t) {
              ...
              if (lastHovered != null && toggled) {
                unHighlightCounties(
                  e(t.v).replaceAll(", ", "").replace("(", "").replace(")", ""),
                  lastHovered
                );
                lastHovered = null;
              }
            ...
            .on("click", function (t) {
              ...
              if (toggleValue % 2 == 0 && lastSelected != id) {
                ...
                d3.select(
                  "#legend".concat(lastSelected.replace("rgb", ""))
                ).style("stroke", "white");
                d3.select(
                  "#legend".concat(lastSelected.replace("rgb", ""))
                ).style("stroke-width", 0.2);
                d3.select("#legend".concat(id.replace("rgb", ""))).style(
                  "stroke",
                  "black"
                );
                d3.select("#legend".concat(id.replace("rgb", ""))).style(
  ...
  function $f(t, e, n) {
    ...
    return (
      (u.makePixelData = function () {
        for (var t, e = [], n = 0; n < i; n++)
          for (var r = 0; r < i; r++)
            (t = Ut((t = qe((t = o(r / i)), Ut("#ddd"))(n / i)))),
              e.push(t.r),
              e.push(t.g),
              e.push(t.b),
              e.push(255);
      ...
      return (
        (c.setProperties = function () {
          if (l) {
            ...
            l.append("g").call(((r = s), x(k, r)).tickFormat(or(y || ""))),
              l
                .append("text")
                .style("text-anchor", "middle")
                .style("font-size", 13)
        ...
        (c.setProperties = function () {
          if (v) {
            ...
            v
              ...
              .call(E(i).tickFormat(d3.format(".5~f"))),
              v
                .append("text")
                .style("text-anchor", "middle")
                .style("font-size", 13)
    ...
    (t.scale = function (t, e, n) {
      ...
      function r(t, e) {
        var n = d(t, e),
          r = [0, 1],
          a = [0, 1];
        d.uncertaintyDomain && (r = d.uncertaintyDomain()),
          d.valueDomain && (a = d.valueDomain());
